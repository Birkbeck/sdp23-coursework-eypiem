...
class AddInstructionFactoryTest {
    private static final Function<String, RegisterName> registerValueOf = Registers.Register::valueOf;
    private static final InstructionFactory factory = new AddInstructionFactory(registerValueOf);
    ...
    void executeValid() {
        ...
        AddInstruction expected = new AddInstruction(label, EAX, EBX);
