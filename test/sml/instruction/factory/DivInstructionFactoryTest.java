...
class DivInstructionFactoryTest {
    private static final Function<String, RegisterName> registerValueOf = Registers.Register::valueOf;
    private static final InstructionFactory factory = new DivInstructionFactory(registerValueOf);
    ...
    void executeValid() {
        ...
        DivInstruction expected = new DivInstruction(label, EAX, EBX);
